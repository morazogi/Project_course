...
public class PurchaseCartUI extends VerticalLayout {
    ...
    @Autowired
    public PurchaseCartUI(UserService userService, RegisteredService registeredService, OwnerManagerService ownerManagerService, IToken tokenService, UserRepository userRepository) {
