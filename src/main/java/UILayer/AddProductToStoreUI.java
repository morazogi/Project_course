...
public class AddProductToStoreUI extends VerticalLayout {
    ...
    @Autowired
    public AddProductToStoreUI(UserService userService, RegisteredService registeredService, OwnerManagerService ownerManagerService, IToken tokenService, UserRepository userRepository) {
