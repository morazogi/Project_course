...
class GuestTest {
    ...
    @Test
    void testAddProduct_NullArguments_ThrowsException() {
        assertThrows(NullPointerException.class, () -> guest.addProduct(null, "prodA", 1));
        assertThrows(NullPointerException.class, () -> guest.addProduct("store1", null, 1));
    }

    @Test
    void testRemoveProduct_NullArguments_ThrowsException() {
        assertThrows(NullPointerException.class, () -> guest.removeProduct(null, "prodA", 1));
        assertThrows(NullPointerException.class, () -> guest.removeProduct("store1", null, 1));
    }
